...
from gfpgan import GFPGANer # this is a python package
...
def enhancer_generator_no_len(images, method='gfpgan', bg_upsampler='realesrgan'):
    ...
    model_path = os.path.join('/hy-tmp/checkpoints/gfpgan/weights', model_name + '.pth')
