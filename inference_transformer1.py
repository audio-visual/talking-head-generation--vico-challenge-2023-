...
if __name__ == '__main__':
    ...
    parser.add_argument("--exp_resume", type=str, default='/hy-tmp/train_transformer_layers2/checkpoints/Epoch_00062000.bin', help="path to model checkpoint.") 
    # parser.add_argument('--pose_config', type=str, default='Exp0531_lstm/configs.yaml') 
    # parser.add_argument("--pose_resume", type=str, default=None, help="path to model checkpoint.") 
    ...
    parser.add_argument('--output_dir', type=str, default='/hy-tmp/outputs/results_transformer_ep62000', help="Dir to save results.")
